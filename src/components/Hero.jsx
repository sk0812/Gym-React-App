  ...
  return (
    <div className="min-h-screen flex flex-col gap-10 items-center justify-center text-center max-w-[800px] w-full mx-auto p-4">
      <div className="flex flex-col gap-4">
        ...
        <h1 className="uppercase font-semibold text-4xl sm:text-5xl md:text-7xl lg:text-7xl">
    ...
    <button className="px-8 py-4 rounded-md border-[2px] blueShadow duration-200 bg-slate-950 border-blue-400 border-solid">
        <p>Accept & Begin</p>
    </button>
